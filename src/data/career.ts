...
export const careerTimeline: CareerTimelineItem[] = [
  ...
  {
    period: '2019–2021',
    title: 'Design-to-Flight Engineer and Metal Finishing Technician',
    organization: 'NASA HUNCH Program',
    startYear: 2019,
    endYear: 2021,
    tone: 'hunch',
    disciplines: ['Flight hardware', 'Manufacturing', 'Verification'],
    bullets: ['Developed and reviewed mechanical drawings for compliance with NASA/JSC manufacturing and safety standards.',
              'Produced verification documentation with traceability similar to licensing-style quality packages required for safety-critical hardware.',
              'Authored assembly and manufacturing procedures for certified flight hardware.',
              'Conducted cost analyses to guide procurement of components and consumables.',
